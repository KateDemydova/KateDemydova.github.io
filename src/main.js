...
function createDomElement(tagName, textContent, container) {
    ...
    throw new Error('container must be valid')
  }
...
function setUserInfoCookie(key, value) {
  ...
  document.cookie = `userInfo=${encodedValue}; ${expires}; path=/; secure; samesite=strict`;

  console.log(`Cookie успішно встановлено: userInfo=${encodedValue} з терміном дії 10 секунд`)
}
